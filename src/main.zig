                        ...
                        if (byte == 'A' or byte == 'B' or byte == 'C' or byte == 'D') {
                            if (sys_composer.active) {
                                ...
                                if (sys_composer.is_scan_active) {
                                    ...
                                    else if (byte == 'D') { if (sys_composer.focus_x > 56) sys_composer.focus_x -= 8;
                                        sys_composer.focus_len = 1; }
                                } else {
                            ...
                            if (sys_hunter.lens.is_scan_active) {
                                    ...
                                    else if (byte == 'C') { sys_hunter.lens.focus_x += 8;
                                        sys_hunter.lens.focus_len = 1; }
                                    else if (byte == 'D') { if (sys_hunter.lens.focus_x > 10) sys_hunter.lens.focus_x -= 8;
                                        sys_hunter.lens.focus_len = 1; }
                                } else {
